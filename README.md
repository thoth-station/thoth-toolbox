...
```shell
[user@hostname ~]$ toolbox create --image quay.io/thoth-station/thoth-toolbox:v0.5.6
Created container: thoth-toolbox
Enter with: toolbox enter --container thoth-toolbox-v0.5.6
[user@hostname ~]$
```
...
```shell
[user@hostname ~]$ toolbox enter --container thoth-toolbox-v0.5.6
⬢[user@toolbox ~]$
```
